          ...
          <div className="flex justify-center gap-3 mt-2">
            ...
            <button className="bg-gradient-to-r from-black to-[#707070] border-4 border-white p-2 rounded-full w-10 aspect-square flex items-center justify-center shadow-[0px_12px_10px_-8px_rgba(133,189,215,0.88)] hover:scale-110 active:scale-95">
              <svg
                ...
                height="24"
              >
                <path d="M22 12c0-5.5-4.5-10-10-10S2 6.5 2 12s4.5 10 10 10 10-4.5 10-10zm-2 0c0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8 8 3.6 8 8zm-5.8-2h-1.2v4.6h-2v-4.6H9.6V8.2h2.4V6.5c0-2.2 1.3-3.6 3.3-3.6 1.1 0 2.2.2 2.4.3v2.6h-1.7c-1.3 0-1.7.6-1.7 1.7v2.2h3.4l-.5 2.4h-2.9V20h5.8c.1-1 .2-2.1.2-3.2v-2.4H16z" />
              </svg>
            </button>
          </div>
        </div>
